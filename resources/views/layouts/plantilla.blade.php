...
<nav class="navbar navbar-light bg-main">
        <div class="container p-1">
            <a class="navbar-brand m-auto" href="#">
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 12rem;" 
                    src="../public/images/logos.png" alt="">
                <img src="{{asset('images/logoletra.png')}}" width="400" alt="" loading="lazy">
            </a>
        </div>
    </nav>
    ...
    <footer class="container-fluid bg-main">
        <div class="row text-center p-4">
            <div class="mb-3">
                <img src="{{asset('images/logoletra.png')}}" alt="YouDevs logo" width="120" id="logofooter">
            </div>
            <div id="col-md-10">
                ...
                <p class="mt-3"> Copyright © 2021 Restaurante Gastronomico "El Buen Sabor" <Br> Todos los derechos reservados. </P>
            </div>
        </div>
    </footer>
