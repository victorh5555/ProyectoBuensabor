...
<section class="container-fluid content py-5"> 
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-7 text-center">
                ...
                <hr>
                <img src="images/8.png" alt="Publicar Javascript" class="img-fluid">
            ...
            <div class="col-md-3 offset-md-1">
                ...
                <div class="row mb-4">
                    <div class="col-4 p-0">
                        <a href="#">
                            <img src="images/3.png" class="img-fluid redondeado" width="100" alt="">
                        </a>
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-4 p-0">
                        <a href="#">
                            <img src="images/5.png" class="img-fluid redondeado" width="100" alt="">
                        </a>
                    </div>
                    <div class="col-7 pl-0">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 col-12 justify-content-center mb-5">
                <div class="card m-auto" style="width: 18rem;">
                    <img class="card-img-top" src="{{asset('images/3.png')}}" alt="Publicar Python">
                    <div class="card-body">
